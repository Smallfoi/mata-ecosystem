...
/// Друзья на карте (D-82..D-85): граф + позиции + приватность + «Маяк» + контакты.
///
/// ВКЛЮЧЕНО 17.09.2026 (`kFriends = true`): раздел «Друзья» и слой друзей на карте
/// активны. Позиция opt-in — по умолчанию тебя никто не видит. TODO до ПУБЛИЧНОГО
/// запуска: возрастной гейт 16+ на включение видимости живой локации (152-ФЗ).
const bool kFriends = true;
